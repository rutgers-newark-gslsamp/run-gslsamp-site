...
export default function Faculty() {
    ...
    return(
        <>
            <Title name={"Faculty"} />
            <p className='whitespace-normal md:ml-[4rem] lg:ml-[4rem] xl:ml-[4rem] ml-[1rem]'>
            ...
            <br/><br/>Faculty members interested in serving as research mentors for LSAMP scholars are invited to submit project descriptions here.  Funding is available for student stipends as well as research support.  
            ...
            <br/><br/>Faculty can also recommend students for the LSAMP program by directing them to our application page.   
            <br/><br/>If you would like more information about the LSAMP program, please feel free to contact us via email <span className='underline text-[#9D1739] hover:text-[#62e8c6]'><a href='/contact'>oren.rabinovich@rutgers.edu</a></span> or by phone <span className='underline text-[#9D1739]'>(973) 353-3562</span>.   
            </p>
