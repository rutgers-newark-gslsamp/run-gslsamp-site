...
export default function Faculty() {
    ...
    return(
        <>
            ...
            <br/><br/>Faculty can also recommend <a className='underline text-[#9D1739] hover:text-[#62e8c6]' href='/membership' target='_blank'>eligible</a> students for the LSAMP program by directing them to our application page.   
