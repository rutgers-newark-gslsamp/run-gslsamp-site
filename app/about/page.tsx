    ...
    <>
      ...
      <main className="about-description-container">
        ...
        <div className="flex flex-rows justify-center py-[.3rem]">
          ...
          <div className="rounded-lg m-[.3rem] bg-red-600">
