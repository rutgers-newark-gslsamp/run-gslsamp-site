        ...
        <main className="overflow-auto">
          ...
          <div className="flex justify-center"> 
            <section className="relative w-[90vw]">  
              <Image className="relative w-[90vw] h-[90vw] md:h-[63vw] rounded-lg " src={diploma} alt="Graduation Diploma" />
              <div className="absolute inset-0 shadow-lg rounded-lg">
                <div className="flex justify-center text-white">
                  <h2 className="md:text-[1.5rem] drop-shadow-lg font-bold italic pl-[.5rem]">
                    As an LSAMP Scholar, you will have outstanding 
                    opportunities to help you complete your undergraduate!
                  </h2>
                </div>

                <div className="flex justify-center mt-1 md:pl-[30rem]">
                ...
                <div className="flex justify-center mb-[2rem]">
                  <article className="overflow-auto w-[90%] h-[48vw] md:h-[35vw] bg-white border-2 border-[#9D1739] rounded-lg shadow-md row-span-3 mt-[3rem]">
