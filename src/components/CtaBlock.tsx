...
const CtaBlock: React.FC = () => {
    return (
        <aside className="md:translate-y-[-90%] flex flex-col items-center justify-center absolute lg:max-w-1/2 w-full md:w-2/5 lg:w-1/3 md:h-1/2 shadow-md md:rounded-3xl px-5 py-2 md:right-5 bg-gradient-to-t from-red-900 to-red-600">
