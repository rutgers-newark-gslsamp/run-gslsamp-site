...
const CtaBlock: React.FC = () => {
    return (
        <aside className="cta-block flex flex-row w-full h-1/3 px-5 py-2.5 items-center lg:flex-col lg:absolute lg:bottom-5 lg:right-3 lg:max-w-1/2 lg:h-2/7 lg:w-1/3 lg:rounded-3xl xl:justify-evenly xl:h-1/3 shadow-md bg-gradient-to-t from-red-900  to-red-600 gap-1 ">
            {/*Box 1*/}
